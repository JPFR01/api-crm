...
(0, globals_1.describe)('V1 presentation controllers refresh-token RefreshTokenController', () => {
    ...
    (0, globals_1.describe)('handle()', () => {
        ...
        (0, globals_1.beforeEach)(() => {
            globals_1.jest.clearAllMocks();
            controller = new RefreshTokenController_1.RefreshTokenController(refreshToken, logger);
        });
        (0, globals_1.afterAll)(() => {
            globals_1.jest.clearAllMocks();
        });
        (0, globals_1.it)('deve ocorrer erro ao fazer login', async () => {
            ...
            globals_1.jest.spyOn(controller['refreshToken'], 'validate').mockRejectedValueOnce(errors_1.InvalidParamError);
            ...
            (0, globals_1.expect)(response.body).toEqual(errorMock.body);
            ...
            (0, globals_1.expect)(refreshToken.validate).toHaveBeenCalledWith(globals_1.expect.any(Object));
        ...
        (0, globals_1.it)('deve chamar o Login com os valores corretos', async () => {
            globals_1.jest.spyOn(controller['logger'], 'info').mockResolvedValueOnce(null);
            globals_1.jest.spyOn(controller['refreshToken'], 'validate').mockResolvedValueOnce(null);
            globals_1.jest.spyOn(controller['refreshToken'], 'refresh').mockResolvedValueOnce(responseMock);
            globals_1.jest.spyOn(controller['logger'], 'info').mockResolvedValueOnce(null);
            const response = await controller.handle(requestMock);
            ...
            (0, globals_1.expect)(refreshToken.validate).toHaveBeenCalledWith(globals_1.expect.any(Object));
            (0, globals_1.expect)(refreshToken.refresh).toHaveBeenCalledWith(globals_1.expect.any(Object));
            (0, globals_1.expect)(controller['logger'].info).toHaveBeenCalledWith(globals_1.expect.objectContaining({
                origem: globals_1.expect.any(String),
                versao: globals_1.expect.any(String),
                destino: globals_1.expect.any(String),
