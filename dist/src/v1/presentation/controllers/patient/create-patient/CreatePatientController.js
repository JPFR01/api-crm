...
class CreatePatientController {
    ...
    async handle(httpRequest) {
        ...
        try {
            ...
            return (0, httpResponseHelper_1.httpResponseHelper)(error, personalDataRequest, 'v1/usuarios/recuperarDadosPessoais', 'recuperarDadosPessoais', 'CreatePatientController');
        }
    }
}
